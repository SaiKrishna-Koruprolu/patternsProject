 ...
 * 
 */
package com.skClasses.DMS.Controllers;
...
import com.skClasses.DMS.Models.Trainer;
import com.skClasses.DMS.repository.DogRepository;
import com.skClasses.DMS.repository.TrainerRepository;
...
//		return home();
		...
		Optional<Integer> dogId = Optional.ofNullable(dog.getId());
		dogId.ifPresent(id -> {
			Optional<Dog> dogFound = dogRepo.findById(id);
			dogFound.ifPresent(d -> dogRepo.delete(d));
		});
